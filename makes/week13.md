...
## Reflection
I imagine the future of AI to be solely dystopian. Going off of what I know now about A.I., and its outlook and development in the future, I can not see any major changes that would allow for a utopian level impact on society. For example, the most practical use of A.I. right now that I could cite is grammar checkers and maybe code writing. Juxtaposing this against potential dystopian-level impacts of A.I., such as allowing for a surveillance state or ease of censorship, I believe that this is a more probable future in terms of AI. I feel as if my visions for the future are telling about the current speculation on A.I. today, and its increasing presence in government affairs; overall, I hold concerns about A.I. and its impacts on generations in our subsequent years.  
## Attribution & AI Use
- Tools used: ChaptGPT (Image Generation), Canva (Eviction Notice Template)
- AI prompts (summary): can you make a furturistic door to an apartment, that allows for a holo display to show automated messages, i like the door, but can you make it so the holo display is blank but looks the exact same. also i want more of a forward facing angle of the door
- What AI generated:See image above (minus the text)
- What you changed or decided: Generating the second image based (listed above) to get a more ideal version of what I wanted
